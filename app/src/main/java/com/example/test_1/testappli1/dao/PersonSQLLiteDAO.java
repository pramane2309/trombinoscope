...
import com.example.test_1.testappli1.sqlite.PersonContract;
import com.example.test_1.testappli1.sqlite.PersonDBHelper;

import java.util.ArrayList;
import java.util.List;

public class PersonSQLLiteDAO implements IPersonDAO {
    ...
    public void addPerson(Person person) {
        ...
        values.put(PersonContract.PersonEntry.COLUMN_NAME_FIRSTNAME, person.getFirstName());
        values.put(PersonContract.PersonEntry.COLUMN_NAME_LASTNAME, person.getLastName());
    ...
    public void removePerson(Person person) {
        ...
        String[] selectionArgs = { person.getFirstName(), person.getLastName() };
        // Issue SQL statement.
